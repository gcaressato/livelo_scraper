        ...
        function ordenarTabela(indiceColuna, tipoColuna) {{
            ...
            linhas.sort((linhaA, linhaB) => {{
                ...
                if (tipoColuna === 'numero') {{
                    ...
                    if (textoA === '-' || textoA === 'Nunca') numA = -999999;
                    if (textoB === '-' || textoB === 'Nunca') numB = -999999;
                    
                    resultado = numA - numB;
                }} else {{
                    // Ordenação de texto
                    if (textoA === '-') textoA = 'zzz';
                    if (textoB === '-') textoB = 'zzz';
                    if (textoA === 'Nunca') textoA = 'zzz';
                    if (textoB === 'Nunca') textoB = 'zzz';
        ...
        document.addEventListener('DOMContentLoaded', function() {{
            ...
            setTimeout(() => {{
                ...
                if (primeiroSelect && primeiroSelect.options.length > 1) {{
                    primeiroSelect.selectedIndex = 1; // Primeiro parceiro real (não a opção vazia)
